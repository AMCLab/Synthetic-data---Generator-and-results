...
dm4_path = "PAT4NANO Data/2021-02-04_silicaSpheres_200nm_A5/dm4"

path_ml = "PAT4NANO Data/2021-02-04_silicaSpheres_200nm_A5/threshold_analysis/machine learning"

path_threshold = "PAT4NANO Data/2021-02-04_silicaSpheres_200nm_A5/threshold_analysis/threshold_algorithms"
...
for data in tqdm(os.listdir(path_ml)):
    ...
    if resolution < 0.0029 and resolution > 0.001: #um
        ...
        print(data[:-4])
        print('Precision ml medium mag: ', float(vals[0][0]))
        print('Recall ml medium mag: ', float(vals[0][1]))
        print('f1 Score ml medium mag: ', float(vals[0][2]))
        print('\n')
        ...
        rc_curve_area_2.append(float(vals[0][4]))
        
        pr_curve_area_2.append(float(vals[0][5]))
        
    elif resolution >= 0.0029: #um
        
        print('\n')
        print(data[:-4])
        print('Precision ml small mag: ', float(vals[0][0]))
        print('Recall ml small mag: ', float(vals[0][1]))
        print('f1 Score ml small mag: ', float(vals[0][2]))
        print('\n')
        ...
        rc_curve_area_1.append(float(vals[0][4]))
        
        pr_curve_area_1.append(float(vals[0][5]))
        
    elif resolution < 0.001 and resolution > 0.00025: #um
        
        print('\n')
        print(data[:-4])
        print('Precision ml large mag: ', float(vals[0][0]))
        print('Recall ml large mag: ', float(vals[0][1]))
        print('f1 Score ml large mag: ', float(vals[0][2]))
        print('\n')
        ...
        rc_curve_area_3.append(float(vals[0][4]))
        
        pr_curve_area_3.append(float(vals[0][5]))
...
for data in tqdm(os.listdir(path_threshold)):
    ...
    if resolution < 0.0029 and resolution > 0.001: #um
        ...
        print('\n')
        print(data[:-4])
        print('Precision threshold medium mag: ', float(vals[0][0]))
        print('Recall threshold medium mag: ', float(vals[0][1]))
        print('f1 Score threshold medium mag: ', float(vals[0][2]))
        print('\n')
        ...
        print('\n')
        print(data[:-4])
        print('Precision threshold small mag: ', float(vals[0][0]))
        print('Recall threshold small mag: ', float(vals[0][1]))
        print('f1 Score threshold small mag: ', float(vals[0][2]))
        print('\n')
        ...
        print('\n')
        print(data[:-4])
        print('Precision threshold large mag: ', float(vals[0][0]))
        print('Recall threshold large mag: ', float(vals[0][1]))
        print('f1 Score threshold large mag: ', float(vals[0][2]))
...
for j in range(len(precisions_thresh)):
    ...
    if save == True:
        ...
        plt.savefig("plots/algo_"+str(j)+"_analysis.pdf", dpi=1000)
    
dm4_path = "PAT4NANO Data/2021-02-04_silicaSpheres_200nm_A5/dm4"

path_ml_curves = "PAT4NANO Data/2021-02-04_silicaSpheres_200nm_A5/threshold_analysis/machine learning"
...
if save == True:
    ...
    plt.savefig("plots/algo_1_curves.pdf", dpi=1000)
...
if save == True:
    ...
    plt.savefig("plots/algo_2_curves.pdf", dpi=1000)
...
if save == True:
    ...
    plt.savefig("plots/algo_3_curves.pdf", dpi=1000)

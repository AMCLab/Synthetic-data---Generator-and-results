...
all_precisions_thresh_err = []

all_precisions_ml_err = []
...
rects1 = ax.bar(x-0.09, all_precisions_ml, width, yerr=all_precisions_ml_err, capsize=5,label='Deep Learning', color = 'cornflowerblue')
rects2 = ax.bar(x+0.09, all_precisions_thresh, width,yerr=all_precisions_thresh_err, capsize=5, label='Best Thresholding Method', color = 'lightcoral')
...
rects1 = ax.bar(x-0.09, all_recalls_ml, width, yerr=all_recalls_ml_err, capsize=5, label='Deep Learning', color = 'cornflowerblue')
rects2 = ax.bar(x+0.09, all_recalls_thresh, width, yerr=all_recalls_thresh_err, capsize=5, label='Best Thresholding Method', color = 'lightcoral')
...
rects1 = ax.bar(x-0.09, all_f1scores_ml, width, yerr=all_f1scores_ml_err, capsize=5,label='Deep Learning', color = 'cornflowerblue')
rects2 = ax.bar(x+0.09, all_f1scores_thresh, width, yerr=all_f1scores_thresh_err, capsize=5, label='Best Thresholding Method', color = 'lightcoral')
...
rects1 = ax.bar(x-0.09, roc, width, yerr=roc_err, capsize=5, label='Precision-Recall Curve', color = 'forestgreen')
rects2 = ax.bar(x+0.09, pr, width, yerr=pr_err, capsize=5,  label='Receiver Operating Characteristic Curve', color = 'darkorange')
